...
v2.5.1 Update: Feedback screens now pause with "Press Enter" 
for better visibility of correct/wrong guesses.
    ...
    while True:
        ...
        if choice.isdigit():
            ...
            if 1 <= choice <= len(keys):
                ...
                clear_screen()
                print(f"Thanks for playing Hangman v2.5.1, {player}! 👋")
                break
