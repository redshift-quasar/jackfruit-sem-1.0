...
# Multiple Categories with Indian Movies
CATEGORIES = {
    "🍎 Fruits": [
...
def get_category_words(choice):
    """Get words list for selected category."""
...
def main():
    while True:
        ...
        if choice in ['1', '2', '3', '4', '5', '6']:
            category_words = get_category_words(choice)
            category_name = get_category_name(choice)
